...
const STATIC_MERGED: MergedPR[] = [
  ...
  { number: 31981, repo: 'helm/helm',            orgInitial: 'H', title: 'fix(kube): clarify server-side apply patch errors',                    description: 'Wrapped generic SSA patch errors with resource context and an explicit "server-side apply failed" prefix; added regression coverage for duplicate-key typed patch errors.', tags: ['Go','Kubernetes','CNCF'], mergedAt: 'Apr 20, 2026', repoStars: '29k+', url: 'https://github.com/helm/helm/pull/31981', ...MERGED_THEMES[2] },
