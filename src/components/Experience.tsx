...
const WORK = [
  {
    id: '01', role: 'Full-Stack Developer', company: 'AvlokanIAS & Others', type: 'Freelance',
    period: 'Apr 2025 – Aug 2025', location: 'Remote',
    highlights: [
    ...
    accentBorder: 'border-t-cyan-500', accentText: 'text-cyan-400',
    badgeBg: 'bg-cyan-500/10 text-cyan-300 border-cyan-500/25',
    pillBg: 'bg-cyan-900/40 text-cyan-200 border-cyan-500/25',
    chevronColor: 'text-cyan-400', glowStyle: '0 0 60px -15px rgba(6,182,212,0.2)',
    dotColor: 'bg-cyan-400 shadow-[0_0_8px_rgba(6,182,212,0.9)]', gridColor: 'rgba(34,211,238,0.04)',
  },
  {
    id: '02', role: 'Associate Software Engineer', company: 'QTIMINDS Pvt Ltd', type: 'Full-time',
    period: 'Dec 2023 – Jan 2025', location: 'India',
    highlights: [
    ...
    accentBorder: 'border-t-purple-500', accentText: 'text-purple-400',
    ...
    chevronColor: 'text-purple-400', glowStyle: '0 0 60px -15px rgba(168,85,247,0.2)',
    dotColor: 'bg-purple-400 shadow-[0_0_8px_rgba(168,85,247,0.9)]', gridColor: 'rgba(168,85,247,0.04)',
  },
]
  ...
  <section id="experience" className="relative py-32 md:py-48 overflow-hidden" style={{ background: 'radial-gradient(ellipse at 75% 50%, #12082a 0%, #07041c 45%, #000 100%)' }}>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      <div className="grid lg:grid-cols-2 gap-5 mb-5">
        {WORK.map((job, idx) => (
          <Reveal key={job.id} from={{ opacity: 0, y: 30 }} delay={idx * 0.1}
            className="group relative rounded-2xl border border-t-2 border-white/10 overflow-hidden bg-white/[0.04] backdrop-blur-xl hover:bg-white/[0.07] transition-all duration-300"
      ...
      <Reveal from={{ opacity: 0, y: 25 }} delay={0.2}
        className="group relative rounded-2xl border border-white/10 overflow-hidden bg-white/[0.04] backdrop-blur-xl hover:bg-white/[0.07] transition-all duration-300"
